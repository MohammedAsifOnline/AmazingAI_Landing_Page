    ...
    <div className="relative pt-24 pb-12 px-6 lg:pt-32 lg:pb-20 overflow-hidden bg-white">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center max-w-4xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 bg-blue-600/5 backdrop-blur-sm border border-blue-100 text-blue-700 px-5 py-2 rounded-full text-sm font-bold mb-8 shadow-sm">
